...
int main(int argc, char *argv[])
{
    ...
    // Shaders
    Shader lightingShader("shaders/lighting.vertex.glsl", "shaders/lighting.fragment.glsl");
    Shader lampShader("shaders/light.vertex.glsl", "shaders/light.fragment.glsl");
